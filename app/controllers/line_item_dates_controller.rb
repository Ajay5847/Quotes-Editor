class LineItemDatesController < ApplicationController
  ...
  def create
    ...
    if @line_item_date.save
      ...
      respond_to do |format|
        format.html { redirect_to quotes_path(@quote), notice: "Date was successfully created." }
  ...
  def update
    if @line_item_date.update(line_item_date_params)
      ...
      respond_to do |format|
        format.html { redirect_to quotes_path(@quote), notice: "Date updated successfully." }
        format.turbo_stream { flash.now[:notice] = "Date updated successfully." }
      end
    else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to quotes_path(@quote), notice: "Date was successfully destroyed." }
