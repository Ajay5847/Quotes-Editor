class LineItemsController < ApplicationController
  ...
  def create
    ...
    if @line_item.save
      ...
      respond_to do |format|
        format.html { redirect_to quote_path(@quote), notice: "Added item successfully." }
        format.turbo_stream { flash.now[:notice] = "Added item successfully." }
      end
    else
  ...
  def update
    if @line_item.update(line_item_params)
      ...
      respond_to do |format|
        format.html { redirect_to quote_path(@quote), notice: "Updated successfully." }
        format.turbo_stream { flash.now[:notice] = "Updated successfully." }
      end
    else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to quote_path(@quote), notice: "Line Item was successfully destroyed." }
